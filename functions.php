 ...
 *
 */
define( 'CHILD_THEME_NAME', 'johnayscough' );
...
function sp_footer_creds_filter( $creds ) {
	$creds = '<p>Copyright ' . do_shortcode('[footer_copyright]') . ' John Ayscough. Contact: <a href="mailto:johnayscough@hotmail.com">johnayscough@hotmail.com</p>';
